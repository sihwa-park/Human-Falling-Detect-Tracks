...
class InferenNet_fast(nn.Module):
    def __init__(self, weights_file='/content/Human_Falling_Detect_Tracks/Models/sppe/fast_res101_320x256.pth'):
        super().__init__()
...
class InferenNet_fastRes50(nn.Module):
    def __init__(self, weights_file='/content/Human_Falling_Detect_Tracks/Models/sppe/fast_res50_256x192.pth'):
        super().__init__()
